...
As the very first task, Let us setup Remote Desktop Connection Manager so that we can RDP into all the Lab Servers (VMs).
    ...
    NOTE: The Lab VM you are connected to, is the Domain Controller VM that we will be using throughout the Lab to connect to other VMs
...
10. In **Role Services**, click **Certification Authority**, click **Certification Authority Web Enrollment**, and then click **Next**.
